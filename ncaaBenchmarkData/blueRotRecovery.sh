...
/dors/meilerlab/data/belle6/rosetta/source/bin/rosetta_scripts.default.linuxgccrelease -s $TARGET -nstruct 1 -out:prefix $ROTDIR/protres/$TNAME/prm_ -parser:protocol rotRecovery.xml -pack_missing_sidechains false -out:level 300 -overwrite -linmem_ig 20 -ignore_zero_occupancy false \
-extra_res_fa \
